...
def mock_xrpl_client():
    ...
    class MockXRPLClient:
        ...
        def setup_success_response(self, tx_hash="E3FE6EA3D48F0C2B639448020EA4F03D4F4F8FFDB243A852A0F59177921B4879"):
...
async def test_e2e_onboarding_balance_beneficiary_send_flow(
    ...
    with patch("httpx.AsyncClient") as mock_http:
        ...
        mock_client.post.return_value = Mock(
            status_code=200, 
            json=lambda: {"success": True, "user_id": user_id}
        )
        ...
        with patch("backend.services.xrp_service.XRPService.create_wallet") as mock_wallet:
            ...
            with patch("backend.services.user_service.UserService.get_user_by_telegram_id") as mock_get:
...
@pytest.mark.integration
@pytest.mark.asyncio
async def test_integration_xrpl_timeout_then_retry_once(
    test_db, mock_xrpl_client, log_capture
):
