...
- Peer-to-peer XRP transfers
- Real-time price tracking
- 1B+ potential users via Telegram
:::
...
|--------|----------|-------|---------|
| xrp_service.py | 94% | 250 | 15 |
| user_service.py | 88% | 180 | 22 |
| encryption.py | 100% | 75 | 0 |
| api/routes.py | 91% | 320 | 29 |
| bot/handlers.py | 85% | 410 | 62 |
| database/models.py | 96% | 120 | 5 |
| **Total** | **89%** | **1355** | **133** |
